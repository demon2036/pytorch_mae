...
class MaeFinetuneTrainer(BaseTrainer):
    ...
    def train(self):
        ...
        self.train_dataloader = pl.MpDeviceLoader(self.train_dataloader, xm.xla_device())

        self.optim = torch.optim.AdamW(self.model.parameters(),
                                       lr=8*self.base_learning_rate * self.batch_size / 256,
...
def main():
    ...
    import torch_xla.distributed.xla_multiprocessing as xmp
    xmp.spawn(_mp_fn, args=(trainer,))

    # notebook_launcher(trainer.train,num_processes=2)
